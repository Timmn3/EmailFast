...
<i>- Срок жизни номера 20 минут</i>
<b>- Если при вводе кода приложение Телеграм выдает ошибку или аккаунт защищен облачным паролем, или на аккаунте уже кто-то зарегистрирован - обязательно отправляйте скриншот в <a href="https://t.me/emailfastsupportbot">@emailfastsupportbot</a></b>
"""
