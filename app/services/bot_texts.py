...
<tg-emoji emoji-id="5258215846450305872">📲</tg-emoji>Принять SMS - номер на 15 минут для конкретного сервиса
...
CONFIRM_RENT_EMAIL = """
<b><tg-emoji emoji-id="5390863029464213754">❌</tg-emoji>Вы собираетесь арендовать Email, он будет выдан автоматически</b>

Срок действия: <b>{dialog_data[rent_text]}</b>
Стоимость: <b>{dialog_data[cost]}₽</b>
Продление и возможность бесплатно менять адрес почты от 199₽/мес
